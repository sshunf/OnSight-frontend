...
import '../css/FoundersNote.css'; // We'll create this file for custom styles
...
function FoundersNotePage() {
  ...
  return (
    <div className="bg-black text-white min-h-screen">
      {/* Asterisk Background */}
      <div className="fixed top-0 left-0 w-full h-full overflow-hidden z-0" id="asteriskContainer"></div>
